...
import org.example.third.tasks.controller.MainController;
...
@Sql(value = {"/delete_messages-after.sql", "/delete-user-after.sql"}, executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
@WithUserDetails("b")
public class MainControllerTest {
    ...
    public void mainPageTest() throws Exception {
        this.mockMvc.perform(get("/"))
                ...
                .andExpect(xpath("//*[@id=\"navbarSupportedContent\"]/div").string("b"));
    }
